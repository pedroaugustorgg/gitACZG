...
public class Task extends JPanel {
    ...
    public void donestatus() {
        ...
        this.taskcategory.setBackground(Color.green);
        this.taskpriority.setBackground(Color.green);
        this.taskstatus.setBackground(Color.green);
